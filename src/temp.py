...
class Network(object):
    ...
    def SGD(self, input_data, epochs, mini_batch_size, eta,
            test_in=None):
        ...
        training_data = self.format_data (input_data)
        training_data = list(training_data)
        n = len(training_data)

        if test_in.any():
            test_data = self.format_data (test_in)
...
if __name__ == '__main__':
    ...
    net.SGD(training_data, 30, 10, 3.0, test_in = valid_ar)
